...
-(void) displayLoginDialogFromViewController:(UIViewController *)viewController withCompletionHandler:(void (^)(SugarSyncLoginStatus aStatus, NSError *error))handler
 {
     NSBundle *myBundle = [NSBundle bundleWithPath:[[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"SugarSyncSDK.bundle"]];
     ...
     loginViewController.completionHandler = handler;
